...
const initialState = {
    ...
    developmentToggles: { usePolling : true, showInterestingStep: false, showConnectionState: true, useAnsiCodeColors: false, handleTriggerSteps: false, useNewPipelineStructure: true},
    showStepToolbox: {},
    showInParallel: {},
    triggerDialog: {},
    showSubsteps: {}
